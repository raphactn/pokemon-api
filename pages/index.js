          ...
          <SimpleGrid columns={{ base: 2, md: 4 }} spacing={[5, 10]}>
            {data.map(item =>
              <Box borderBottom={'8px solid #feca1b'} bg={'#feca1b54'} p={5} borderRadius={10}>
                <Image src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${item.url.substr(-2).replace('/', "")}.png`} w={150} cursor='pointer' alt={item.name} />
